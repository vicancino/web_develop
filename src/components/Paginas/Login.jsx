    ...
    return (
        <div className="container_login">
            ...
            <div className='inputs_login'>
                {action === "Login" ? <div></div> : <div className='input_login'>
            ...
            {action === "Sign Up" ? <div></div> : <div className='forgot-password_login'>Lost Password <span> Click Here!</span></div>}

            <div className='submit-container_login'>
                <div className={action === "Sign Up" ? "submit_login gray_login" : "submit_login"} onClick={() => { setAction("Sign Up") }}>Sing up</div>
                <div className={action === "Login" ? "submit_login gray_login" : "submit_login"} onClick={() => { setAction("Login") }}>Login</div>
            </div>
        </div>
    )
}